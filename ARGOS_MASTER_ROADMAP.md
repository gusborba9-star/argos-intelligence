...
**Implementation state:** code block implemented; validation gates remain open until Vercel and quantitative validation are confirmed Ready.

- [x] Canonical MarketVertical universe expanded to distinct result, period, team-stat and count-stat dimensions
- [x] Canonical MarketCoverageRegistry established
...
- [x] MarketNormalizer delegated to canonical coverage registry
- [x] Unknown provider markets remain observable rather than fabricated
- [x] Coverage invariants added to `tests/quant/market-coverage-registry.test.ts`
